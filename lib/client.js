	...
	factory: (require) => {
		...
		function ensureStyle() {
			...
			style.textContent = [
				...
				// 通用卡片容器：层次通透，0.5px border
				'.dsh-llm-hub-card{display:flex;flex-direction:column;gap:8px;margin-top:8px;',
				'padding:10px 12px;border-radius:8px;border:.5px solid var(--dsw-alias-border-l1);',
				'background:var(--dsw-alias-bg-layer-2);font-size:12px;line-height:18px;color:var(--dsw-alias-label-secondary)}',
				...
				'.dsh-llm-hub-card__actions{display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;',
				'padding-top:6px;border-top:.5px solid var(--dsw-alias-border-l1)}',
				'.dsh-llm-hub-card__btn-group{display:flex;align-items:center;gap:6px;flex-wrap:wrap}',
				...
				'.dsh-llm-hub-balance--stack{flex-direction:column;align-items:stretch;gap:8px}',
				...
				'.dsh-llm-hub-amount{font-size:14px;font-weight:600;color:var(--dsw-alias-label-primary);',
				'font-variant-numeric:tabular-nums;letter-spacing:-0.2px}',
				'.dsh-llm-hub-amount.is-low{color:var(--dsw-alias-state-error-primary)}',
				'.dsh-llm-hub-subtext{font-size:11px;color:var(--dsw-alias-label-secondary);opacity:.85}',
				...
				'.dsh-llm-hub-tag{display:inline-flex;align-items:center;gap:4px;padding:1px 6px;border-radius:4px;',
				'border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);',
				'color:var(--dsw-alias-label-secondary);font-size:11px;white-space:nowrap;line-height:16px}',
				'.dsh-llm-hub-tag--muted{opacity:.65}',
				'.dsh-llm-hub-warn-badge{display:inline-flex;align-items:center;gap:3px;padding:1px 6px;border-radius:4px;',
				'border:.5px solid var(--dsw-alias-state-warn-primary);background:rgba(234,179,8,.08);',
				'color:var(--dsw-alias-state-warn-primary);font-size:11px}',
				// 精致微操作按钮
				'.dsh-llm-hub-btn{box-sizing:border-box;display:inline-flex;align-items:center;gap:4px;',
				'height:24px;padding:0 8px;font:inherit;font-size:11px;line-height:1;color:var(--dsw-alias-label-primary);',
				'background:var(--dsw-alias-bg-layer-1);cursor:pointer;border:.5px solid var(--dsw-alias-border-l2);',
				'border-radius:5px;white-space:nowrap;transition:all .15s ease}',
				'.dsh-llm-hub-btn:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);',
				'border-color:var(--dsw-alias-border-l3)}',
				'.dsh-llm-hub-btn:disabled{cursor:default;opacity:.5}',
				// API Key Badge：彻底杜绝 emoji，精致内联 SVG
				'.dsh-llm-hub-key-badge{box-sizing:border-box;display:inline-flex;align-items:center;',
				'height:22px;padding:0 4px 0 7px;gap:4px;border-radius:5px;flex:0 0 auto;margin-left:auto;',
				...
				'font-size:11px;cursor:pointer;user-select:none;transition:all .15s ease;max-width:280px}',
				'.dsh-llm-hub-quota-bar{display:flex;align-items:center;gap:6px;flex-wrap:wrap}',
				'.dsh-llm-hub-key-badge:hover{border-color:var(--dsw-alias-border-l3);color:var(--dsw-alias-label-primary);',
				...
				'.dsh-llm-hub-key-badge__copied{display:inline-flex;align-items:center;gap:4px;font-weight:500}',
				'.dsh-llm-hub-key-badge__btn{display:inline-flex;align-items:center;justify-content:center;',
				'width:18px;height:18px;padding:0;border:0;background:0 0;color:inherit;cursor:pointer;',
				...
				'.dsh-llm-hub-dot-sep{opacity:.4;margin:0 1px}',
				// harness
				...
				'.dsh-llm-hub-chip{box-sizing:border-box;display:inline-flex;align-items:center;height:22px;padding:0 7px;',
				'border-radius:11px;font-size:11px;line-height:14px;white-space:nowrap;',
				...
				'.dsh-llm-hub-usage__tag{display:inline-flex;align-items:center;gap:4px;padding:1px 6px;',
				'border-radius:4px;border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-3);font-size:11px}',
				...
				'border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-2);',
				'font-size:12px;line-height:18px;color:var(--dsw-alias-label-secondary)}',
				'.dsh-llm-hub-health__head{display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap}',
				'.dsh-llm-hub-health__title{color:var(--dsw-alias-label-primary);font-weight:600}',
				'.dsh-llm-hub-health__rows{display:flex;flex-direction:column;gap:3px}',
				'.dsh-llm-hub-health__row{display:flex;align-items:center;gap:8px;flex-wrap:wrap;',
				'padding:3px 6px;border-radius:5px;background:var(--dsw-alias-bg-layer-1)}',
				'.dsh-llm-hub-health__name{color:var(--dsw-alias-label-primary);font-weight:500;',
				'min-width:90px}',
				'.dsh-llm-hub-health__chip{display:inline-flex;align-items:center;height:18px;padding:0 6px;',
				'border-radius:4px;border:.5px solid var(--dsw-alias-border-l3);',
				'font-size:10px;line-height:16px;color:var(--dsw-alias-label-secondary)}',
				'.dsh-llm-hub-health__chip--available{border-color:var(--dsw-alias-state-success-primary,#3fb950);',
				'color:var(--dsw-alias-state-success-primary,#3fb950);background:rgba(63,185,80,.08)}',
				'.dsh-llm-hub-health__chip--unavailable{border-color:var(--dsw-alias-state-error-primary);',
				'color:var(--dsw-alias-state-error-primary);background:rgba(239,68,68,.08)}',
				'.dsh-llm-hub-health__chip--unknown{border-color:var(--dsw-alias-border-l3);',
				'color:var(--dsw-alias-label-secondary)}',
				'.dsh-llm-hub-health__metric{font-size:11px;opacity:.85;font-variant-numeric:tabular-nums}',
				'.dsh-llm-hub-health__metric--time{margin-left:auto;opacity:.65}',
				'.dsh-llm-hub-health__reason{color:var(--dsw-alias-state-warn-primary);',
				'max-width:240px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px}',
				// 当前路由卡
				...
				'.dsh-llm-hub-routing__role{display:inline-flex;align-items:center;height:18px;padding:0 6px;',
				'border-radius:4px;border:.5px solid var(--dsw-alias-border-l3);',
				'background:var(--dsw-alias-bg-layer-3);font-size:10px;color:var(--dsw-alias-label-secondary)}',
			...
			return h('div', { className: 'dsh-llm-hub-card' },
				h('div', { className: 'dsh-llm-hub-card__meta' },
					h('div', { className: 'dsh-llm-hub-card__tags' },
						...
						breakdown.length > 0 ? h('span', { className: 'dsh-llm-hub-tag' }, breakdown.join(' · ')) : null,
				...
				h('div', { className: 'dsh-llm-hub-card__actions' },
					h('button', {
						type: 'button',
						className: 'dsh-llm-hub-btn',
						disabled: isRefreshing,
						onClick: load
					}, h(RefreshIcon, { spinning: isRefreshing }), isRefreshing ? t('loading') : t('refresh')),
					h('span', { className: 'dsh-llm-hub-subtext' }, state.isAvailable ? '官方接口连通正常' : t('unavailable'))
				)
			)
		}
		...
		function PiAiCard(props) {
			...
			if (typeof status.baseURL === 'string' && status.baseURL !== '') {
				...
				tags.push(h('span', {
					key: 'base',
					className: 'dsh-llm-hub-tag',
					title: `${t('endpoint')}: ${status.baseURL}`
				}, host))
			}
			const balanceText = renderBalance(balance, t)
			const quotaLine = balanceText !== null
				? h('div', { key: 'quota-bar', className: 'dsh-llm-hub-quota-bar' },
					h('span', { className: 'dsh-llm-hub-tag' }, balanceText),
					warning !== null && warning.level === 'low'
						? h('span', { className: 'dsh-llm-hub-warn-badge', title: warning.text }, '⚠️ 额度偏低')
						: null)
				: null
			...
			if (noBaseURL) {
				actionsLeft.push(h('span', { key: 'nobase', className: 'dsh-llm-hub-subtext' }, t('noBaseURLHint')))
			} else {
				const probing = probe !== null && probe.phase === 'loading'
				actionsLeft.push(probeBtn('probe', probing ? t('probing') : t('probe'), probing, probing, runProbe))

				const pulling = catalog !== null && catalog.phase === 'loading'
				actionsLeft.push(probeBtn('catalog', pulling ? t('pulling') : t('pullCatalog'), pulling, pulling, pullCatalog))
			}
			...
			if (probe !== null && probe.phase === 'done') {
				...
				if (body?.ok === true && body.reachable === true) {
					actionsRight.push(h('span', { key: 'probe-ok', className: 'dsh-llm-hub-status-text' },
						h('span', { className: 'dsh-llm-hub-status-dot is-ok' }),
						h('span', null, `${body.latencyMs}ms`),
						h('span', { className: 'dsh-llm-hub-dot-sep' }, '·'),
						h('span', null, `${t('remoteCount')} ${body.remoteCount}`)
					))
				} else {
					actionsRight.push(h('span', { key: 'probe-bad', className: 'dsh-llm-hub-status-text is-err' },
						h('span', { className: 'dsh-llm-hub-status-dot is-err' }),
						h('span', null, `${t('unreachable')}: ${body?.error ?? ''}`)
					))
				}
			}
			...
			if (!noBaseURL && catalog !== null && catalog.phase === 'done') {
				...
				if (body?.ok === true && Array.isArray(body.models)) {
					actionsRight.push(h('span', { key: 'cat-count', className: 'dsh-llm-hub-subtext' }, `${t('remoteCount')} ${body.models.length} · ${body.latencyMs}ms`))
					actionsLeft.push(probeBtn('copy', copied ? t('copied') : t('copyIds'), false, false, copyIds))
					...
					actionsRight.push(h('span', { key: 'cat-bad', className: 'dsh-llm-hub-error' }, `${t('failed')}: ${body?.error ?? ''}`))
				}
			}
			...
			return h('div', null,
				h('div', { className: 'dsh-llm-hub-card', title: quotaNote },
					...
					quotaLine,
					h('div', { key: 'actions', className: 'dsh-llm-hub-card__actions dsh-llm-hub-actions' },
						h('div', { className: 'dsh-llm-hub-card__btn-group' }, actionsLeft),
						h('div', { className: 'dsh-llm-hub-card__status-group' }, actionsRight)
					)
				),
				picker)
		}
